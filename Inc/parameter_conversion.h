...
#define _Q7(u, b) ((int64_t)INT8_MAX * u / b)
#define _Q10(u, b) ((int64_t)Q10_BASE * u / b)
#define _Q14(u, b) ((int64_t)Q14_BASE * u / b)
#define _Q15(u, b) ((int64_t)INT16_MAX * u / b)
#define _Q31(u, b) ((int64_t)INT32_MAX * u / b)
...
#define MphToRPM_Conversion(Mph, WheelDiameter_mm) ((int32_t)((1609.34f * 1000.0f / (60.0f * 3.141592654f * (float)WheelDiameter_mm )) * (float)Mph))
