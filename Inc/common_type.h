...
#define Q7_BASE  (1 << 7)    // 128
#define Q8_BASE  (1 << 8)    // 256
#define Q10_BASE (1 << 10)   // 1024
#define Q14_BASE (1 << 14)   // 16384
#define Q15_BASE (1 << 15)   // 32768
#define Q16_BASE (1 << 16)   // 65536
#define Q31_BASE (1LL << 31) // 2147483648
#define Q32_BASE (1ULL << 32) // 4294967296

#define Q14_DIVISOR (16384) /* Keep because of legacy reasons. Should use Q14_BASE */
